...
// Access to PLCore/BREthereum types
typealias PLCoreEthereumLightNode = OpaquePointer
...
protocol EthereumClient: class {
    ...
    func getTransactions (address: String, completion: @escaping TransactionsHandler)

    func getLogs (address: String, contract: String?, event: String, completion: @escaping LogsHandler)
...
class EthereumLightNode: EthereumPointer {
    ...
    /// to this reference.
    ///
    let core: PLCoreEthereumLightNode
    ...
    private init (core: PLCoreEthereumLightNode,
    ...
    static func lookupNode (core: PLCoreEthereumLightNode) -> EthereumLightNode? {
