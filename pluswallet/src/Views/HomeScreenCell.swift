...
//        
//        homeCollection.collectionView?.isPagingEnabled  = true
//        homeCollection.collectionView?.showsVerticalScrollIndicator = false
...
//    
//    func setup() {
//        addSubview(homeScreenCollectionViewController.view)
//        homeScreenCollectionViewController.view.translatesAutoresizingMaskIntoConstraints = false
//        homeScreenCollectionViewController.view.topAnchor.constraint(equalTo: topAnchor).isActive = true
//        homeScreenCollectionViewController.view.trailingAnchor.constraint(equalTo: trailingAnchor).isActive = true
//        homeScreenCollectionViewController.view.leadingAnchor.constraint(equalTo: leadingAnchor).isActive = true
//        homeScreenCollectionViewController.view.bottomAnchor.constraint(equalTo: bottomAnchor).isActive = true
//    }
