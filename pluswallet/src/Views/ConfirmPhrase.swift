...
class ConfirmPhrase: UIView {
    ...
    private func setupSubviews() {
        ...
        textField.layer.backgroundColor = #colorLiteral(red: 0.9234612944, green: 0.9234612944, blue: 0.9234612944, alpha: 1)
        ...
        textField.constrain([
           ...
           textField.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 2/3)])
