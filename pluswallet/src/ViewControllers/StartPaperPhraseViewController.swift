...
class StartPaperPhraseViewController: UIViewController {
    ...
    init(callback: @escaping () -> Void) {
        ...
        button = GradientButton(title: buttonTitle)
...
//            pencil.constraint(.top, toView: illustration, constant: -4.0) ])
        explanation.constrain([
            ...
            explanation.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant : -C.padding[4]),
            explanation.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant : -C.padding[2]),
            explanation.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant : C.padding[2])
