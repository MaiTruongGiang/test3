...
enum PhraseEntryReason {
    case setSeed(EnterPhraseCallback) // lan dau import vi
    case validateForResettingPin(EnterPhraseCallback) // reset lai ma pin
    case validateForWipingWallet(()->Void) // xac thuc de xoa vi
}
