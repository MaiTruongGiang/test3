...
class ConfirmPaperPhraseViewController: UIViewController {
    ...
    //private let header = RadialGradientView(backgroundColor: .blue , offset: 1.0 )
...
//            header.constraint(.height, constant: 160.0)
//            ])
        label.constrain([
...
//            label.bottomAnchor.constraint(equalTo: header.bottomAnchor, constant: -5)
        ...
        confirmFirstPhrase.constrain([
            confirmFirstPhrase.constraint(toBottom: header, constant: 10.0),
