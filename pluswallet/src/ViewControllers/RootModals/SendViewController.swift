...
//  Pluswallet
//
//  Created by Zan on 2016-11-30.
//  Copyright © 2016 Pluswallet LLC. All rights reserved.
//
...
class SendViewController : UIViewController, UIScrollViewDelegate, Subscriber, ModalPresentable, Trackable {
    ...
    private let titlelbl = UILabel(font: UIFont.boldSystemFont(ofSize: 25), color: .white)
    private let subHeaderTitlelbl = UILabel(font: UIFont.boldSystemFont(ofSize: 17), color: .white)
    ...
    private func setConstrains() {
        ...
        addressCell.constrain([
            addressCell.topAnchor.constraint(equalTo: header.bottomAnchor, constant: C.padding[2]),
            addressCell.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            addressCell.trailingAnchor.constraint(equalTo: view.trailingAnchor),
        ...
        sendButton.constrain([
           ...
           // sendButton.constraint(toBottom: amountView.view, constant: verticalButtonPadding),
            sendButton.constraint(.height, constant: C.Sizes.buttonHeight),
            sendButton.bottomAnchor.constraint(equalTo: scrollView.bottomAnchor, constant: E.isIPhoneX ? -C.padding[5] : -C.padding[2]),
            sendButton.topAnchor.constraint(equalTo: amountView.view.bottomAnchor , constant : verticalButtonPadding)
            ])
    ...
    private func setStyle() {
         ...
         subHeaderTitlelbl.text = S.SendViewController.insertAddressAmount
         sendButton.container.backgroundColor = currency.colors.0
    }
    // MARK: - Actions
...
//        }
    ...
    @objc private func scanTapped() {
        ...
        //print("scan testttttttttttttttttttttttttt")
...
//        print("Hien thi ban phim ")
        copyKeyboardChangeAnimation(notification: notification)
    }

    @objc private func keyboardWillHide(notification: Notification) {
//        print("tat hien thi ban phim")
        copyKeyboardChangeAnimation(notification: notification)
    }
