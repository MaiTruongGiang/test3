...
class ModalViewController: UIViewController, Subscriber {
    ...
    private func addConstraints() {
        ...
        header.constrain([
            ...
            header.heightAnchor.constraint(equalToConstant: E.isIPhoneX ? 122 : 100)])
    ...
    private func setInitialData() {
        ...
        Store.subscribeAsTrigger(self, name: .blockModalDismissal, callback: { _ in
            self.tapGestureRecognizer.isEnabled = false
        })

        Store.subscribeAsTrigger(self, name: .unblockModalDismissal, callback: { _ in
