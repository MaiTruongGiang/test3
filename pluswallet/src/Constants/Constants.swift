...
struct C {
    ...
    static let walletQueue = "enzi.pluswallet.walletqueue"
    ...
    static let bCashForkTimeStamp: TimeInterval = E.isTestnet ?
        (1501597117 - NSTimeIntervalSince1970) : (1501568580 - NSTimeIntervalSince1970)
