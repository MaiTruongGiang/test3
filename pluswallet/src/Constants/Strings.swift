...
let profileURL = "http://192.168.8.18:3000/"
...
enum S {
    ...
    enum Send {
        ...
        static let cameraUnavailableTitle = NSLocalizedString("Send.cameraUnavailableTitle", value: "Plus is not allowed to access the camera", comment: "Camera not allowed alert title")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value: "DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Plus's keychain data and steal your bitcoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
        static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value: "DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Plus's keychain data and steal your bitcoin. Please only use Plus on a non-jailbroken device.", comment: "Jailbreak warning message")
    ...
    enum UnlockScreen {
        ...
        static let touchIdPrompt = NSLocalizedString("UnlockScreen.touchIdPrompt", value: "Unlock your Plus.", comment: "TouchID/FaceID prompt text")
    ...
    enum Transaction {
        ...
        static let tokenTransfer = NSLocalizedString("Transaction.tokenTransfer", value: "Fee for token transfer: %1$@", comment: "Fee for token transfer: Plus")
    }
    ...
    enum SecurityCenter {
        ...
        enum Cells {
            ...
            static let pinDescription = NSLocalizedString("SecurityCenter.pinDescription", value: "Protects your Plus from unauthorized users.", comment: "PIN button description")
            static let touchIdTitle = NSLocalizedString("SecurityCenter.touchIdTitle", value: "Touch ID", comment: "Touch ID button title")
            static let touchIdDescription = NSLocalizedString("SecurityCenter.touchIdDescription", value: "Conveniently unlock your Plus and send money up to a set limit.", comment: "Touch ID/FaceID button description")
    ...
    enum UpdatePin {
        ...
        static let createInstruction = NSLocalizedString("UpdatePin.createInstruction", value: "Your PIN will be used to unlock your Plus and send money.", comment: "PIN creation info.")
    ...
    enum RecoverWallet {
        ...
        static let intro = NSLocalizedString("RecoverWallet.intro", value: "Recover your Plus with your paper key.", comment: "Recover wallet intro")
    ...
    enum AccountHeader {
        static let defaultWalletName = NSLocalizedString("AccountHeader.defaultWalletName", value:"My Plus", comment: "Default wallet name")
        static let equals = NSLocalizedString("AccountHeader.equals", value:"=", comment: "Equals symbol")
        static let exchangeRate = NSLocalizedString("Account.exchangeRate", value:"%1$@ = 1 %2$@", comment: "$10000 = 1BTC")
    }
    ...
    enum TouchIdSettings {
        ...
        static let label = NSLocalizedString("TouchIdSettings.label", value: "Use your fingerprint to unlock your Plus and send money up to a set limit.", comment: "Touch Id screen label")
        static let switchLabel = NSLocalizedString("TouchIdSettings.switchLabel", value: "Enable Touch ID for Plus", comment: "Touch id switch label.")
    ...
    enum FaceIDSettings {
        ...
        static let label = NSLocalizedString("FaceIDSettings.label", value: "Use your face to unlock your Plus and send money up to a set limit.", comment: "Face Id screen label")
        static let switchLabel = NSLocalizedString("FaceIDSettings.switchLabel", value: "Enable Face ID for Plus", comment: "Face id switch label.")
    ...
    enum Settings {
        ...
        static let enjoying = NSLocalizedString("Settings.enjoying", value: "Are you enjoying Plus?", comment: "Are you enjoying Plus alert message body")
        ...
        // Plus Wallet
        static let helps = NSLocalizedString("helps", value: "Help", comment: "Help Settings section header")
        static let profile = NSLocalizedString("profile", value: "Profile", comment: "Profile Settings label")
        static let security = NSLocalizedString("security", value: "Security", comment: "Security Settings label")

    }

    enum Profile {
        static let title = NSLocalizedString("Profile.title", value: "Profile", comment: "Profile screen title")
        static let username = NSLocalizedString("Profile.username", value: "Username", comment: "Username label")
        static let unamePlaceholder = NSLocalizedString("Profile.unameHolder", value: "Please input username", comment: "Username placeholder")
        static let update = NSLocalizedString("Profile.username", value: "Update", comment: "Update label")
        static let logout = NSLocalizedString("Profile.logout", value: "Logout", comment: "Logout")
        static let iconSelection = NSLocalizedString("Profile.username", value: "Select Icon", comment: "Select Icon label")
    }
    ...
    enum About {
        ...
        static let walletID = NSLocalizedString("About.walletID", value: "Plus Rewards ID", comment: "About screen wallet ID label")
        static let footer = NSLocalizedString("About.footer", value: "Made by the global Plus team. Version %1$@", comment: "About screen footer")
    }
    ...
    enum PushNotifications {
        ...
        static let body = NSLocalizedString("PushNotifications.body", value: "Turn on notifications to receive special messages from Plus in the future.", comment: "Push notifications settings view body")
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value: "If a transaction shows as completed on the network but not in your Plus.", comment: "Syncing explanation")
    ...
    enum ShareData {
        ...
        static let body = NSLocalizedString("ShareData.body", value: "Help improve Plus by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
    ...
    enum StartPaperPhrase {
        static let body = NSLocalizedString("StartPaperPhrase.body", value: "Your paper key is the only way to restore your Plus if your phone is lost, stolen, broken, or upgraded.\n\nWe will show you a list of words to write down on a piece of paper and keep safe.", comment: "Paper key explanation text.")
    ...
    enum MenuButton {
        ...
        // PlusWallet
        static let profile = NSLocalizedString("profile", value: "Profile", comment: "Menu button title")
        static let about = NSLocalizedString("about", value: "About", comment: "Menu button title")
    }
    ...
    enum HomeScreen {
        ...
        static let currency = NSLocalizedString("HomeScreen.currency", value: "Currency", comment: "Currency")
        static let allView = NSLocalizedString("HomeScreen.allView", value: "All View ＞", comment: "All View")
    }
    ...
    enum Watch {
        static let noWalletWarning = NSLocalizedString("Watch.noWalletWarning", value: "Open the Plus iPhone app to set up your wallet.", comment: "'No wallet' warning for watch app")
    }
    ...
    enum Prompts {
        ...
        enum UpgradePin {
            ...
            static let body = NSLocalizedString("Prompts.UpgradePin.body", value: "Plus has upgraded to using a 6-digit PIN. Tap Continue to upgrade.", comment: "Upgrade PIN prompt body.")
        }
        ...
        enum ShareData {
            ...
            static let body = NSLocalizedString("Prompts.ShareData.body", value: "Help improve Plus by sharing your anonymous data with us", comment: "Share data prompt body")
        }
        enum FaceId {
    ...
    enum LocationPlugin {
        ...
        static let notAuthorized = NSLocalizedString("LocationPlugin.notAuthorized", value: "Plus does not have permission to access location services.", comment: "No permissions for location services")
    }
    ...
    enum Import {
        ...
        static let rightCaption = NSLocalizedString("Import.rightCaption", value: "Your Plus Wallet", comment: "Caption for graphics")
        static let importMessage = NSLocalizedString("Import.message", value: "Importing a wallet transfers all the money from your other wallet into your Plus wallet using a single transaction.", comment: "Import wallet intro screen message")
    ...
    enum WipeWallet {
        ...
        static let startMessage = NSLocalizedString("WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different Plus wallet on this device.", comment: "Start wipe wallet view message")
    ...
    enum Welcome {
        static let title = NSLocalizedString("Welcome.title", value: "Plus now supports Ethereum!", comment: "Welcome view title")
    ...
    enum AccountViewController{
        static let tradeHistory = NSLocalizedString("AccountViewController.tradeHistory", value: "Trade History", comment: "Trade History")
    }
    
    enum TxListCell{
        static let completed = NSLocalizedString("TxListCell.completed", value: "Completed", comment: "Completed")
        static let pending = NSLocalizedString("TxListCell.pending", value: "Pending", comment: "Pending")
    }
    
    enum PortofolioViewController{
        static let totalBalance = NSLocalizedString("PortofolioViewController.totalBalance", value: "Total Balance", comment: "Total Balance")
        static let numberOfCurrencyOwned = NSLocalizedString("PortofolioViewController.numberOfOwnedCurrency", value: "Number owned currencies", comment: "Number of owned currencies")
        static let ownedCurrencyList = NSLocalizedString("PortofolioViewController.ownedCurrencyList", value: "List Owned Currency", comment: "List Owned Currency")
    }
    
    enum AllCurrencyViewController{
        static let sorting = NSLocalizedString("AllCurrencyViewController.sorting", value: "Sorting", comment: "Sorting")
        static let allCurrency = NSLocalizedString("AllCurrencyViewController.allCurrency", value: "All Currency", comment: "All Currency")
        static let chooseDisplayCurrency = NSLocalizedString("AllCurrencyViewController.chooseDisplayCurrency", value: "Choose Display Currency", comment: "Choose Display Currency")
    }
    
    enum SendViewController{
        static let insertAddressAmount = NSLocalizedString("SendViewController.insertAddressAmount", value: "Please Enter Address And Amount", comment: "Please Enter Address And Amount")
    }
    
    enum ShowTokenListViewController{
        static let changePosition = NSLocalizedString("ShowTokenListViewController.changePosition", value: "You can change currency's position when click and drag it", comment: "Please Enter Address And Amount")
        static let allCurrency = NSLocalizedString("ShowTokenListViewController.allCurrency", value: "All Currency", comment: "All Currency")
    }
    
    enum ReceiveViewController{
        static let receive = NSLocalizedString("ReceiveViewController.receive", value: "Receive", comment: "Receive")
        static let receivePage = NSLocalizedString("ReceiveViewController.receivePage", value: "Receive Page", comment: "receivePage")
        static let shareQRCode = NSLocalizedString("ReceiveViewController.shareQRCode", value: "Share QR Code", comment: "Share QR Code")
        static let copyQRCode = NSLocalizedString("ReceiveViewController.copyQRCode", value: "Copy QR Code", comment: "Copy QR Code")
        static let footer = NSLocalizedString("ReceiveViewController.footer", value: "This address is only for receiving currency. \n Even if you tell others, you still not be stolen the currency", comment: "footer")
    }
}
