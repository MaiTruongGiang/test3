...
extension UIColor {
    ...
    static var gradientStart: UIColor {
        return UIColor(red: 0/255.0, green: 161.0/255.0, blue: 235.0/255.0, alpha: 1.0)
    }

    static var gradientEnd: UIColor {
        return UIColor(red: 0/255.0, green: 158.0/255.0, blue: 151.0/255.0, alpha: 1.0)
    }
    ...
    static var bluePlus: UIColor {
        return UIColor(red: 0/255.0, green: 161.0/255.0, blue: 235.0/255.0, alpha: 1.0)
    }

    static var greenPlus: UIColor {
        return UIColor(red: 0/255.0, green: 158.0/255.0, blue: 151.0/255.0, alpha: 1.0)
    }
    ...
    static var blueBackground: UIColor {
        return UIColor(red: 230/255, green: 240/255, blue: 240/255, alpha: 1.0)
    }

    static var darkGrayTransparent: UIColor {
        return UIColor(red: 84.0/255.0, green: 104.0/255.0, blue: 117.0/255.0, alpha: 0.3)
    }
    ...
    static var FacebookColor: UIColor {
        return UIColor(red: 58.0/255.0, green: 92.0/255.0, blue: 169.0/255.0, alpha: 1.0)
    }
    
    static var GmailColor: UIColor {
        return UIColor(red: 215.0/255.0, green: 66.0/255.0, blue: 56.0/255.0, alpha: 1.0)
    }
}
